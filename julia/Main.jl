...
function main()
    ...
    for s =1:Numb_SIMs
        ...
        for k=1:Numb_kaps
            ...
            ### Sub3 ###
            Theta[k], theta[k], eta[k], Obj[k]  = Solving_sub_prob3_2(T_cmp[k],E_cmp[k],T_com[k],E_com[k])
            # Theta1[k], theta1[k], eta1[k], Obj1[k]  = Solving_sub_prob3_search_2(T_cmp[k],E_cmp[k],T_com[k],E_com[k])
...
function main_sub1()
    ...
    for s =1:Numb_D
        for k=1:Numb_kaps
            ...
            ### Sub3 ###
            Theta[s,k], theta[s,k], eta[s,k], Obj1[s,k]  = Solving_sub_prob3_2(T_cmp1[s,k],E_cmp1[s,k],T_com1[s,k],E_com1[s,k])
