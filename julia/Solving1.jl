...
function Solving_sub_prob3_1( T_cmp, E_cmp, T_com, E_com)
    println("\n===== Solving Sub3: Solver =====\n")
...
function Solving_sub_prob3_search_1( T_cmp, E_cmp, T_com, E_com)
...
function Solving_sub_prob3_search_2( T_cmp, E_cmp, T_com, E_com)
    x = collect(1.e-5:0.0003:0.99)
    y = collect(1.e-5:0.0003:0.99)
